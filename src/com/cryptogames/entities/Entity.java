...
public class Entity {
	...
	public static BufferedImage[] ENEMY_SPRITE_RIGHT = {Game.spritesheet.getSprite(48, 16, 16, 16)};
	public static BufferedImage[] ENEMY_SPRITE_LEFT  = {Game.spritesheet.getSprite(32, 16, 16, 16)};
	
	
	public static BufferedImage MOEDA  = Game.spritesheet.getSprite(48, 0, 16, 16);
