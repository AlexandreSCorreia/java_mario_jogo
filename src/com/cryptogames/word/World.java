...
public class World {
			...
			for(int xx=0; xx< map.getWidth();xx++) {
				for(int yy= 0; yy< map.getHeight();yy++) {
					...
					if(pixelAtual == 0xff000000) {
						...
						//Tile inteligente verifica o tile de cima se é o mesmo se for ele troca a sprite que será reenderizada
	...
	//Metodo de colisão verifica se estou coilidindo com o tile da parede
	...
	public void render(Graphics g) {
		...
		//Inicio da reenderização
		int xstart = Camera.x>>4;
		int ystart = Camera.y>>4;
		//Final da reenderização
