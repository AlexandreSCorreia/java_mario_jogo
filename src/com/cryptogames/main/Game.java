...
public class Game extends Canvas implements Runnable,KeyListener,MouseListener,MouseMotionListener{
	...
	public Game() {
		...
		//Posicao do player no meio da tela
		player = new Player(0,0,16,16,2,Entity.Player_SPRITE_RIGHT[0]);	
		try {
		...
		//adicionar o player na lista de entidades
		entities.add(player);
	...
	void render() {	
		...
		g.drawImage(fundo, 0, 0,WIDTH,HEIGHT, null);
		//Reenderiza game
	...
	public void keyPressed(KeyEvent e) {
		...
		if(e.getKeyCode() == e.VK_SPACE || e.getKeyCode() == e.VK_UP || e.getKeyCode() == e.VK_W) {
			player.jump=true;
		}
